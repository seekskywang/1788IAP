...
//	LPC_IOCON->P0_29 &= ~0x9F; /* USB_D+1 @ P0.29 */
//	LPC_IOCON->P0_29 |= 0x01; /* USB_D+1 @ P0.29 */
//	LPC_IOCON->P0_30 &= ~0x9F; /* USB_D-1 @ P0.30 */
//	LPC_IOCON->P0_30 |= 0x01; /* USB_D-1 @ P0.30 */


	LPC_IOCON->P1_19 &= ~0x1F; /* USB_PPWR1N @ P1.19 */
	LPC_IOCON->P1_19 |= 0x02; /* USB_PPWR1N @ P1.19 */
	LPC_IOCON->P1_22 &= ~0x1F; /* USB_PWRD1 @ P1.22 */
	LPC_IOCON->P1_22 |= 0x02; /* USB_PWRD1 @ P1.22 */
	LPC_IOCON->P1_27 &= ~0x1F; /* USB_OVRCR1N @ P1.27 */
	LPC_IOCON->P1_27 |= 0x02; /* USB_OVRCR1N @ P1.27 */
...
//	LPC_IOCON->P0_12 |= 0x01; /* USB_PPWR2N @ P0.12 */
	...
	LPC_GPIO0->DIR |= 1 << 17;	   // power to USB2 BUS
	LPC_GPIO0->CLR |= 1 << 17;
